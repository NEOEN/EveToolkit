...
class LoyaltyApi
{
     ...
     * @return \App\EveApi\Esi\Model\GetCharactersCharacterIdLoyaltyPoints200Ok[]
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetCharactersCharacterIdLoyaltyPoints200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\App\EveApi\Esi\Model\GetCharactersCharacterIdLoyaltyPoints200Ok[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetCharactersCharacterIdLoyaltyPoints200Ok[]',
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\EveApi\Esi\Model\GetLoyaltyStoresCorporationIdOffers200Ok[]
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetLoyaltyStoresCorporationIdOffers200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getLoyaltyStoresCorporationIdOffersWithHttpInfo($corporation_id, $datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\App\EveApi\Esi\Model\GetLoyaltyStoresCorporationIdOffers200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetLoyaltyStoresCorporationIdOffers200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetLoyaltyStoresCorporationIdOffersNotFound',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
