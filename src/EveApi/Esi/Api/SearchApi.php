...
class SearchApi
{
     ...
     * @return \App\EveApi\Esi\Model\GetCharactersCharacterIdSearchOk
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetCharactersCharacterIdSearchOk, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\App\EveApi\Esi\Model\GetCharactersCharacterIdSearchOk';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetCharactersCharacterIdSearchOk',
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\EveApi\Esi\Model\GetSearchOk
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetSearchOk, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\App\EveApi\Esi\Model\GetSearchOk';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetSearchOk',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
