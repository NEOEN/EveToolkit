...
class UserInterfaceApi
{
     ...
     *
     * @param  \App\EveApi\Esi\Model\PostUiOpenwindowNewmailNewMail $new_mail The details of mail to create (required)
     * @param  string $datasource The server name you would like data from (optional, default to tranquility)
     * @param  string $token Access token to use if unable to set a header (optional)
     *
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 422:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\PostUiOpenwindowNewmailUnprocessableEntity',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
