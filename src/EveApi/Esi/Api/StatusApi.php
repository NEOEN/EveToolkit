...
class StatusApi
{
     ...
     * @return \App\EveApi\Esi\Model\GetStatusOk
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetStatusOk, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatusWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\App\EveApi\Esi\Model\GetStatusOk';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetStatusOk',
