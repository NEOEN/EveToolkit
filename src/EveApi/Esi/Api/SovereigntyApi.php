...
class SovereigntyApi
{
     ...
     * @return \App\EveApi\Esi\Model\GetSovereigntyCampaigns200Ok[]
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetSovereigntyCampaigns200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSovereigntyCampaignsWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\App\EveApi\Esi\Model\GetSovereigntyCampaigns200Ok[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetSovereigntyCampaigns200Ok[]',
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\EveApi\Esi\Model\GetSovereigntyMap200Ok[]
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetSovereigntyMap200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSovereigntyMapWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\App\EveApi\Esi\Model\GetSovereigntyMap200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetSovereigntyMap200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\EveApi\Esi\Model\GetSovereigntyStructures200Ok[]
     */
     ...
     * @throws \App\EveApi\Esi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\EveApi\Esi\Model\GetSovereigntyStructures200Ok[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getSovereigntyStructuresWithHttpInfo($datasource = 'tranquility', $if_none_match = null)
    {
        $returnType = '\App\EveApi\Esi\Model\GetSovereigntyStructures200Ok[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\EveApi\Esi\Model\GetSovereigntyStructures200Ok[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
